...
| [VoceChat](https://github.com/5656565566/nonebot-adapter-vocechat)     | adapters.vocechat                    |
...
| 元素\适配器           | OneBot V11 | OneBot V12 | Telegram | 飞书 | Github | QQ-API | ⚠️钉钉 | Console | 开黑啦 | ⚠️Mirai | ⚠️Ntchat | Minecraft | Discord | ⚠️Red | Satori | Dodo IM | ⚠️Kritor | Tailchat | Mail | Matrix | 微信公众号 | 黑盒语音 | Milky | EFChat | B站直播间 | 云湖 | VoceChat |
|------------------|------------|------------|----------|----|--------|--------|------|---------|-----|---------|----------|-----------|---------|-------|--------|---------|----------|----------|------|--------|-------|------|-------|--------|-------|----|----------|
| 文本 Text          | ✅          | ✅          | ✅        | ✅  | ✅      | ✅      | ✅    | ✅       | ✅   | ✅       | ✅        | ✅         | ✅       | ✅     | ✅      | ✅       | ✅        | ✅        | ✅    | ✅      | ✅     | ✅    | ✅     | ✅      | ✅     | ✅  | ✅        |
| 样式文本 Styled Text | 🚫         | 🚫         | ✅        | ❌  | ✅      | ✅      | ❌    | ✅       | ✅   | 🚫      | 🚫       | ✅         | 🚫      | 🚫    | ✅      | 🚫      | 🚫       | ✅        | ✅    | ⬆️     | 🚫    | 🚫   | 🚫    | ❌      | 🚫    | ✅  | ✅        |
| 提及用户 At(user)    | ✅          | ✅          | ✅        | ✅  | ⬆️     | ✅      | ✅    | 🚫      | ✅   | ✅       | ❌        | 🚫        | ✅       | ✅     | ✅      | ✅       | ✅        | ✅        | ⬆️   | ✅      | 🚫    | ⬆️   | ✅     | ✅      | ✅     | ✅  | ✅        |
...
| 操作\适配器        | OneBot V11 | OneBot V12 | Telegram | 飞书 | Github | QQ-API | ⚠️钉钉 | Console | 开黑啦 | ⚠️Mirai | ⚠️Ntchat | Minecraft | Discord | ⚠️Red | Satori | Dodo IM | ⚠️Kritor | Tailchat | Mail | Matrix | 微信公众号 | 黑盒语音 | Milky | EFChat | B站直播间 | 云湖 | VoceChat |
|---------------|------------|------------|----------|----|--------|--------|------|---------|-----|---------|----------|-----------|---------|-------|--------|---------|----------|----------|------|--------|-------|------|-------|--------|-------|----|----------|
| 发送 Send       | ✅          | ✅          | ✅        | ✅  | ✅      | ✅      | ✅    | ✅       | ✅   | ✅       | ✅        | ✅         | ✅       | ✅     | ✅      | ✅       | ✅        | ✅        | ✅    | ✅      | ✅     | ✅    | ✅     | ✅      | ✅     | ✅  | ✅        |
| 撤回 Recall     | ✅          | ✅          | ✅        | ✅  | ❌      | ✅      | ❌    | 🚫      | ✅   | ✅       | ❌        | 🚫        | ✅       | ✅     | ✅      | ✅       | ✅        | ✅        | 🚫   | ✅      | 🚫    | 🚫   | ✅     | 🚫     | 🚫    | ✅  | ✅        |
| 编辑 Edit       | 🚫         | 🚫         | ✅        | ✅  | ❌      | 🚫     | ❌    | 🚫      | ✅   | 🚫      | 🚫       | 🚫        | ✅       | 🚫    | ✅      | ✅       | 🚫       | 🚫       | ❌    | ❌      | 🚫    | 🚫   | 🚫    | 🚫     | 🚫    | ✅  | ✅        |
